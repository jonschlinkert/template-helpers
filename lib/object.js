...
exports.forIn = function forIn(o, fn, context) {
  for (var key in o) {
    if (fn.call(context, o[key], key, o) === false) {
      break;
    }
  }
};
...
exports.forOwn = function forOwn(o, fn, context) {
  exports.forIn(o, function(val, key) {
    if (hasOwn.call(o, key)) {
      return fn.call(context, o[key], key, o);
    }
  });
};
...
exports.extend = function extend(o) {
  if (utils.typeOf(o) !== 'object') { return ''; }
  var args = arguments;
