...
exports.dirname = function dirname(fp) {
...
exports.filename = function filename(fp) {
...
exports.extname = function extname(fp) {
...
exports.segments = function segments(fp, a, b) {
...
/**
 * Determines whether path is an absolute path. An
 * absolute path will always resolve to the same
...
exports.isAbsolute = function isAbsolute(fp) {
