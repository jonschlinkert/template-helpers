...
exports.dirname = function dirname_(fp) {
...
exports.basename = function basename_(fp) {
...
exports.filename = function filename_(fp) {
...
exports.extname = function extname_(fp) {
...
exports.resolve = function resolve_() {
...
exports.relative = function relative_(a, b) {
  return rel(a, b);
};
...
exports.segments = function segments_(fp, a, b) {
...
exports.isAbsolute = function isAbsolute_(fp) {
...
exports.isRelative = function isRelative_(fp) {
  return !path.isAbsolute(fp);
};
