...
### [.after](./lib/arrays.js#L64)

* `array` **{Array}**: Collection    
* `n` **{Number}**: Number of items to exclude    
* `returns` **{Array}**: Array exluding items before the given number.  

Returns all of the items in an arry after the specified number.

### [.join](./lib/arrays.js#L78)
