...
* **[segments](#segments)** ([code](lib/path.js#L153) | [unit tests](test/path.js#L108))
* **[join](#join)** ([code](lib/path.js#L175) | [unit tests](test/path.js#L101))
* **[isAbsolute](#isAbsolute)** ([code](lib/path.js#L210) | [unit tests](test/path.js#L82))
* **[isRelative](#isRelative)** ([code](lib/path.js#L245) | [unit tests](test/path.js#L63))
